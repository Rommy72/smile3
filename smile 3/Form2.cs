...
namespace SMILE
{
    public partial class Form2 : Form
    {
       ...
       private void button2_Click(object sender, EventArgs e)
        {
            SetValueForTextboxm1Suku = textBoxm1Suku.Text;
            SetValueForTextboxm1Etu = textBoxm1Etu.Text;
            SetValueForTextboxm1Hetu = textBoxm1Hetu.Text;
            SetValueForTextboxm2Suku = TextBoxm2Suku.Text;
            SetValueForTextboxm1Etu = textBoxm2Etu.Text;
            SetValueForTextboxm1Hetu = textBoxm2Hetu.Text;
            SetValueForTextboxm1Suku = textBoxm3Suku.Text;
            SetValueForTextboxm1Etu = textBoxm3Etu.Text;
            SetValueForTextboxm1Hetu = textBoxm3Hetu.Text;
            SetValueForTextboxm1Suku = textBoxm4Suku.Text;
            SetValueForTextboxm1Etu = textBoxm4Etu.Text;
            SetValueForTextboxm1Hetu = textBoxm4Hetu.Text;
            SetValueForTextboxm1Suku = textBoxm5Suku.Text;
            SetValueForTextboxm1Etu = textBoxm5Etu.Text;
            SetValueForTextboxm1Hetu = textBoxm5Hetu.Text;
